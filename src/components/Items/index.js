        ...
        duplicatedData.map((item, idx) => {
            ...
            return (
                <TableRow key={idx}>
                    ...
                    <TableCell
                        className={cn(classes.item, checkEmail(item[3]) ? '' : classes.error)}>
                        {item[3]}
                    </TableCell>
                    ...
                    <TableCell
                        className={cn(
                            classes.item,
                            checkYearlyIncome(item[6]) ? '' : classes.error,
                        )}>
                    ...
                    <TableCell
                        className={cn(classes.item, checkDate(item[9]) ? '' : classes.error)}>
                        {item[9]}
                    </TableCell>
                    <TableCell
